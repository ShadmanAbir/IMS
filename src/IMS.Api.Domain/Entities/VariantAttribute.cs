...
public class VariantAttribute : SoftDeletableEntity<Guid>
{
    ...
    private VariantAttribute(Guid id, string name, string value, AttributeDataType dataType) : base(id)
    {
        Name = name;
        Value = value;
        DataType = dataType;
    ...
    public static VariantAttribute Create(string name, string value, AttributeDataType dataType)
    {
        ...
        return new VariantAttribute(Guid.NewGuid(), name.Trim(), value.Trim(), dataType);
    }
